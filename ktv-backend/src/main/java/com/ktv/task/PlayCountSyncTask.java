...
public class PlayCountSyncTask {
    ...
    public void syncPlayCountToDb() {
        ...
        try {
            ...
            try {
                String currentLockValue = stringRedisTemplate.opsForValue().get(RedisKeyConstants.LOCK_PLAY_COUNT_SYNC);
                if (lockValue.equals(currentLockValue)) {
                    stringRedisTemplate.delete(RedisKeyConstants.LOCK_PLAY_COUNT_SYNC);
